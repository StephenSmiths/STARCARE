...
npm run gatea:evidence:all # Gate A：開頭自動跑 preflight strict，再 auto/http／summary／snippet／判定稿／doctor／report，並同步五份 markdown（可 `--no-preflight` 略過前置檢查）
