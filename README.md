...
npm run test:e2e:smoke   # build:demo 後僅跑 e2e/smoke.spec.ts（較快；含 #system-settings 本機 group／Pdf16 清單區／政策清單收合展開／五區 aria-controls id 相異／審計展開收合與 hidden 等 Seq 29 P1 煙霧，見 docs/seq29-system-settings-pdf02-traceability.md 第 4 節）
npm run test:e2e:system-settings-policy # build:demo 後 Seq 29 P1 系統設定 demo（無 Supabase；Pdf16／政策清單收合展開／五區 aria-controls id 相異／審計展開收合等；見 docs/uat/system-settings-policy-p1-uat-and-staging-2026-05-09.md 與 docs/seq29-system-settings-pdf02-traceability.md 第 4 節）
