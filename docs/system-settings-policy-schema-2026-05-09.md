...
> **對照骨架與測試**：**`docs/seq29-system-settings-pdf02-traceability.md`** 第 4 節、**`docs/seq29-system-settings-pdf02-traceability-revision-log.md`**；**Staging／UAT**（**二之一** 無 env 指令表；段末 **工程維護互鏈**）：**`docs/uat/system-settings-policy-p1-uat-and-staging-2026-05-09.md`**；**`npm run test:e2e:system-settings-policy`**、**`npm run test:e2e:smoke`**（**`hash #system-settings`**）。
...
| 2026-05-09 | 開首 **對照骨架與測試** 併 **`docs/seq29-system-settings-pdf02-traceability-revision-log.md`**。 |
