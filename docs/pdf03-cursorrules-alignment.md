...
- [ ] **測試**：網域規則至少一則單元測試（若可測）。  
- [ ] **Seq 29【16】政策 P1（demo E2E）**：變更 **`#system-settings`** 政策版本區 UI 或相關指令時，維護 **`e2e/system-settings-policy-p1-demo.spec.ts`**、**`npm run test:e2e:system-settings-policy`**、**`npm run test:e2e:smoke`**（**`hash #system-settings`**），並與 **`docs/feature-list.md`** §8 第 5 點、**`docs/uat/system-settings-policy-p1-uat-and-staging-2026-05-09.md`**（**二之一**）、**`README.md`** 常用指令對齊（與下項 **文件入口** 並讀）。  
