...
- [ ] **測試**：網域規則至少一則單元測試（若可測）。  
- [ ] **Seq 29【16】政策 P1（demo E2E）**：變更 **`#system-settings`** 政策版本區 UI 或相關指令時，維護 **`e2e/system-settings-policy-p1-demo.spec.ts`**、**`npm run test:e2e:system-settings-policy`**，並與 **`docs/feature-list.md`** §8 第 5 點、**`docs/uat/system-settings-policy-p1-uat-and-staging-2026-05-09.md`**、**`README.md`** 常用指令對齊（與下項 **文件入口** 並讀）。  
...
- 變更 **Seq 29** 系統設定政策 P1（**`#system-settings`** 政策版本區、相關 **`scheduling-policy-*`** 或 demo E2E）時，檢視 **`e2e/system-settings-policy-p1-demo.spec.ts`**、**`npm run test:e2e:system-settings-policy`**、**`docs/feature-list.md`** §8 第 5 點與 **`docs/uat/system-settings-policy-p1-uat-and-staging-2026-05-09.md`** 是否仍一致。  
