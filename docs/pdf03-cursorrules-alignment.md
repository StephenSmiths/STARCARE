...
- 變更 **Supabase 部署步驟**、**SQL 驗收**、**`ops:deploy:all` 列舉**或**前端 CI 煙霧（§6）**時，同步 **`docs/supabase-deploy-runbook.md`**，並視需要更新 **`README.md`** 文件表、**`docs/feature-list.md` §7** 與 **`docs/pdf-sequenced-gap-checklist.md`** 日誌。
