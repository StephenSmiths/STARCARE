...
| 2026-05-23 | §0：**02【16】院舍政策** 段補 **UAT** **二之一** 與 **`test:e2e:system-settings-policy`**／**`test:e2e:smoke`**（**`#system-settings`**）、**`docs/seq29-system-settings-pdf02-traceability.md`** 第 4 節。 |
