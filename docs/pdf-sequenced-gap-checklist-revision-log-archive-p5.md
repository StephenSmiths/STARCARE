...
> **對照**：主修訂日誌 **`docs/pdf-sequenced-gap-checklist-revision-log.md`**；**2026-05-01a**、**`archive-p2`**～**`archive-p4`** 見既有歸檔檔。**Archive seq29-2026-05-09b**（**Seq 29** 互鏈批量列）見 **`docs/pdf-sequenced-gap-checklist-revision-log-archive-seq29-2026-05-09b.md`**。**Archive gate-a-stdout-2026-05-09**（**Gate A**／stdout 細列）見 **`docs/pdf-sequenced-gap-checklist-revision-log-archive-gate-a-stdout-2026-05-09.md`**。本檔收錄自該主日誌再拆出之原列 **12–35**（**2026-05-03**：運維與工程、**`npm run ci`**、憑證、**`.cursorrules`** §3、**`acceptance:*`** 與多檔 **對照** 句之批量列），以符合主日誌單檔 ≤200 行。
