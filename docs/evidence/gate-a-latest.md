...
- 更新時間：2026-05-06T15:54:54.804Z
- 判定狀態：`NOT_READY`
- HTTP 嚴格取證：OFF
- auto evidence：`docs/evidence/gate-a-auto-evidence-2026-05-06-165413.md`
- 401：`docs/evidence/gate-a-d2-401-admin-user-role-set-2026-05-06-155438.8.txt`
- 403：`（未找到）`
- doctor：`docs/evidence/gate-a-evidence-doctor-20260506-155439.md`
