...
- D2（§1）：
  - auto 證據：`docs/evidence/gate-a-auto-evidence-2026-05-15-041120.md`
  - 401 證據：`docs/evidence/gate-a-d2-401-admin-user-role-set-2026-05-15-031146.1.txt`
  - 403 證據：`docs/evidence/gate-a-d2-403-admin-user-role-set-2026-05-15-031146.1.txt`
- D3（§3）：
...
> 其餘人工證據請依 docs/gate-a-manual-evidence-checklist-2026-05-06.md 補齊。
