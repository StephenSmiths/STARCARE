...
- 401：`docs/evidence/gate-a-d2-401-admin-user-role-set-2026-05-07-060918.9.txt`
- 403：`docs/evidence/gate-a-d2-403-admin-user-role-set-2026-05-07-060918.9.txt`

## 自動產物
- doctor：`docs/evidence/gate-a-evidence-doctor-20260507-060920.md`（完成度 2 / 12）
