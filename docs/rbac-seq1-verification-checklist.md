...
> **對照**：運維與閘門總覽 **`docs/business-logic.md`** §0（**`.cursorrules`** §3）；審計正式庫抽測 **`docs/go-live-checklist.md`** §8；序號主檔「**運維與工程**」列見 **`docs/pdf-sequenced-gap-checklist.md`**；**全案收尾**：**`README.md`**「專案收尾」、**`docs/project-completion-evidence-index-2026-05.md`**、**`docs/project-completion-kickoff-checklist-2026-05.md`**。
