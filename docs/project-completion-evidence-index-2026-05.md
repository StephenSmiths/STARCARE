...
> **對照（運維鏈）**：**`docs/business-logic.md`** §0；序號主檔 **`docs/pdf-sequenced-gap-checklist.md`**「**運維與工程**」列；**`pdf-sequenced-gap-checklist-revision-log`** 主檔與歸檔（**`2026-05-01a`**／**`archive-p2`**／**`archive-p3`**／**`archive-p4`**／**`archive-p5`**）路徑見 **`README.md`**「專案收尾」文件表；上線 **`docs/go-live-checklist.md`**。  
