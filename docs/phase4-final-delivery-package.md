...
> **對照**：交付索引 **`docs/phase4-day4-delivery-index.md`**；運維與 CI 總覽 **`docs/business-logic.md`** §0（**`.cursorrules`** §3）、**`docs/feature-list.md`** §8（**`npm run ci`**／**`acceptance:day4`**）；序號主檔「**運維與工程**」列 **`docs/pdf-sequenced-gap-checklist.md`**。
