...
> **對照**：運維與文件總覽 **`docs/business-logic.md`** §0（**`.cursorrules`** §3）；上一階 **`docs/phase3-day5-acceptance.md`**／**`docs/phase3-day5-acceptance-result-2026-04-30.md`**；窄版 **`acceptance:day4`** 與全閘 **`npm run ci`** 對照見 **§二** 及 **`docs/feature-list.md`** §8。
