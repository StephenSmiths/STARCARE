...
| 2026-05-09 | §7：**`scheduling-rules-get`** 補 **`therapistGroupSessionsDailyCap`**／**`assistantGroupSessionsDailyCap`**（**`numericLimits`**）；互鏈 Edge 契約、**`seq29`** §3。 |
