...
- Gate A 自動證據：`docs/evidence/gate-a-auto-evidence-2026-05-14-223001.md`
- Gate A 401：`docs/evidence/gate-a-d2-401-admin-user-role-set-2026-05-14-213028.9.txt`
- Gate A 403：`docs/evidence/gate-a-d2-403-admin-user-role-set-2026-05-14-213028.9.txt`
- Gate A decision ref：`docs/evidence/gate-a-decision-ref-20260514-213031.md`
- Gate A fill snippet：`docs/evidence/gate-a-fill-snippet-20260514-213031.md`
- Gate A report：`docs/evidence/gate-a-report-20260514-213031.md`
