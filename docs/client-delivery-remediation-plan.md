...
| 2026-05-09 | **§2 第 4 點**：補 **`docs/scheduling-policy-edge-function-contract.md`**（Seq 29 **`scheduling-policy-*`**）與院友／評估契約並列；補 **Seq 29 系統設定**前向煙霧（**UAT** **二之一**（段末 **工程維護互鏈**）／**二之二** **P2**、**`seq29-system-settings-pdf02-traceability.md`**、**`seq29-system-settings-pdf02-traceability-revision-log.md`**）。 |
