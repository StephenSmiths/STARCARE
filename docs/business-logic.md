...
**專案工程規範（`.cursorrules`）**：**§3**「部署與驗收閘門」與上列 **`runbook`**／憑證／**`README.md`**／**`go-live-checklist.md`**（開首 **對照** 指 **`README.md`**「專案收尾」修訂日誌主檔與 **`2026-05-01a`**／**`archive-p2`**／**`archive-p3`**／**`archive-p4`** 歸檔路徑）連動並讀；修訂該段時見 **`docs/pdf03-cursorrules-alignment.md`** §4。  
