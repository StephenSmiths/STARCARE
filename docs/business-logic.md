...
**02【16】院舍政策（多表＋`effective_from`）**：**`docs/system-settings-policy-prd-2026-05-09.md`**、**`docs/system-settings-policy-schema-2026-05-09.md`**（**`seq29-system-settings-pdf02-traceability.md`** §6 互鏈）；**`docs/scheduling-policy-edge-function-contract.md`**（Edge **`scheduling-policy-*`** 契約）。  
