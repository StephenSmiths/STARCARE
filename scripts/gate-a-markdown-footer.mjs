...
/** 全案收尾（第一則 blockquote；併主日誌 **Gate A／stdout** 歸檔互鏈，與 **`docs/gate-a-manual-evidence-checklist-2026-05-06.md`** 開首同款）＋收證指令／旗標細部並併 **人工／strict-http／keep=1**（第二則；對應 **status** **§5**／**commands-appendix**／人工表開首；不含「此檔為固定入口」）。 */
